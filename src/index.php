...
" href="#">DivSavvy.com</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#">Die Earthings </a>
                        </li>
                    </ul>
...
<li class="list-group-item">git add .     (2)</li>
<li class="list-group-item">git commit    (3)</li>
...
Create a /path/to/my/codebase/.git directory.
    ...
    Record the pristine state as the first commit in the history.
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/images/2016Featured/appalachian-trail400X.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/images/2016Featured/400X400-25Percent-games002.jpg" alt="Card image cap">
                    <div class="card-body"> 
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/images/2016Featured/400x400-25Percentv013.png" alt="Card image cap">
                    <div class="card-body">
                        <h4 class="card-title">Card title</h4>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This
                            card has even longer content than the first to show that equal height action.</p>
